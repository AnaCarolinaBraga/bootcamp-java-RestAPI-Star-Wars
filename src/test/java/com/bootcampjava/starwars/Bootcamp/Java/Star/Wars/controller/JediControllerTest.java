package com.bootcampjava.starwars.Bootcamp.Java.Star.Wars.controller;
...
public class JediControllerTest {
    ...
    public void testGetJediByIdWithSuccess() throws Exception {
        ...
        mockMvc.perform(get("/jedi/{id}", 1))
                ...
                .andExpect(header().string(HttpHeaders.ETAG, "\"1\""))    //Tag do nosso jedi
                .andExpect(header().string(HttpHeaders.LOCATION, "/jedi1"))  //O que eu espero que tenha na minha localização em formato de String
    ...
    public void testGetJediByIdNotFound() throws Exception {      //Quando o original tem um try/catch, precisa adicionar esse throws exception
